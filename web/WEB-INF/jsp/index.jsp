...
<body>
	<c:if test="${param.category != null}">
		<c:set var="categoryParam" value="&category=${param.category}"></c:set>
	</c:if>
	<c:if test="${param.category == null}">
	...
	<div class="header">
		...
		<div class="menu"   onclick="show_menu()" onmouseleave="show_menu1()">
			 ...
			 <ul id="title">
				<li><a href="/page?category=1">现实主义</a> </li>
				<li><a href="/page?category=2">抽象主义</a> </li>
			 </ul>
		</div>
		<div class="auth">
			<ul>
	...
	<div class="content">
	  ...
	  <div class="page-nav">
		<ul>
			<li><a href="/page?page=1${categoryParam}">首页</a></li>
			<li><a href="/page?page=${pageModel.hasPreviousPage ? pageModel.page-1 : 1}${categoryParam}">上一页</a></li>
			<c:forEach begin="1" end="${pageModel.totalPage}" var="pno" step="1">
				<li>
					<span ${pno==pageModel.page ? "class='first-page'" : ""}>
						<a href="/page?page=${pno}${categoryParam}">
								${pno}
						</a>
					</span>
				</li>
			</c:forEach>
			<li><a href="/page?page=${pageModel.hasNextPage ? pageModel.page+1 : pageModel.totalPage}${categoryParam}">下一页</a></li>
			<li><a href="/page?page=${pageModel.totalPage}${categoryParam}">尾页</a></li>
		</ul>
	  </div>
	</div>
	<div class="footer">
