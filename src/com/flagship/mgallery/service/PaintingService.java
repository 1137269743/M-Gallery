package com.flagship.mgallery.service;

import com.flagship.mgallery.dao.PaintingDao;
...
public class PaintingService {
    ...
    public PageModel pagination(int page, int rows, String...category) {
        ...
        if (page <= 0) {
            throw new RuntimeException("无效的page参数");
        }
    ...
    public Painting findById(Integer id) {
        ...
        if (painting == null) {
            throw new RuntimeException("[" + id +"]油画不存在");
        }
        return painting;
    }
